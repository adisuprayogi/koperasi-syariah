...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-900 mt-4">Tambah Anggota Baru</h1>
        <p class="text-gray-600 mt-2">Daftarkan anggota baru ke dalam sistem koperasi</p>
    </div>
    ...
    <form action="{{ route('pengurus.anggota.store') }}" method="POST">
        ...
        <div class="bg-white shadow rounded-lg">
            ...
            <div class="px-6 py-4 border-t border-gray-200">
                <h3 class="text-lg font-medium text-gray-900">
                    <i class="fas fa-user-circle mr-2"></i>Akun Pengguna
                </h3>
            </div>
            <div class="px-6 py-4 space-y-4">
                <div class="bg-blue-50 border border-blue-200 rounded-md p-4">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-blue-800">Pembuatan Akun Otomatis</h3>
                            <div class="mt-2 text-sm text-blue-700">
                                <p>Sistem akan otomatis membuat akun pengguna untuk anggota ini dengan:</p>
                                <ul class="list-disc list-inside mt-1 space-y-1">
                                    <li>Username: nomor anggota (di-generate otomatis)</li>
                                    <li>Email: untuk komunikasi dan notifikasi</li>
                                    <li>Password: yang akan diisi di bawah</li>
                                    <li>Role: Anggota</li>
                                    <li>Status: Perlu mengganti password pada login pertama</li>
                                </ul>
                            </div>
                        </div>
                    </div>
