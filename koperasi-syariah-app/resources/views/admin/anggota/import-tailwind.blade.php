                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-4 py-3 text-sm text-gray-900">N</td>
                                    <td class="px-4 py-3 text-sm font-medium text-gray-900">status_keanggotaan</td>
                                    <td class="px-4 py-3 text-sm text-gray-600">Pilihan</td>
                                    <td class="px-4 py-3"><span class="px-2 py-1 text-xs font-medium bg-gray-100 text-gray-800 rounded-full">Opsional</span></td>
                                    <td class="px-4 py-3 text-sm text-gray-600">aktif/tidak_aktif/keluar</td>
                                </tr>
                                <tr class="hover:bg-gray-50 bg-green-500">
                                    <td class="px-4 py-3 text-sm font-medium text-white">O</td>
                                    <td class="px-4 py-3 text-sm font-medium text-white">tanggal_gabung</td>
                                    <td class="px-4 py-3 text-sm text-white">Date</td>
                                    <td class="px-4 py-3"><span class="px-2 py-1 text-xs font-medium bg-white text-green-600 rounded-full">Wajib</span></td>
                                    <td class="px-4 py-3 text-sm text-white font-mono">2025-12-16</td>
                                </tr>
                                <tr class="hover:bg-gray-50">
                                    <td class="px-4 py-3 text-sm text-gray-900">P</td>
                                    <td class="px-4 py-3 text-sm font-medium text-gray-900">tanggal_keluar</td>
                                    <td class="px-4 py-3 text-sm text-gray-600">Date</td>
                                    <td class="px-4 py-3"><span class="px-2 py-1 text-xs font-medium bg-gray-100 text-gray-800 rounded-full">Opsional</span></td>
                                    <td class="px-4 py-3 text-sm text-gray-600">2025-11-30 (isi jika status keluar)</td>
                                </tr>
                                <tr class="hover:bg-gray-50">
                                    <td class="px-4 py-3 text-sm text-gray-900">Q</td>
                                    <td class="px-4 py-3 text-sm font-medium text-gray-900">alasan_keluar</td>
                                    <td class="px-4 py-3 text-sm text-gray-600">Text</td>
                                    <td class="px-4 py-3"><span class="px-2 py-1 text-xs font-medium bg-gray-100 text-gray-800 rounded-full">Opsional</span></td>
                                    <td class="px-4 py-3 text-sm text-gray-600">Pindah tugas (isi jika status keluar)</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <ul class="mt-1 text-sm text-yellow-700 space-y-1">
                                    ...
                                    <li>• <strong>Status Keanggotaan (Kolom N):</strong> Pilihan: aktif, tidak_aktif, keluar</li>
                                    <li>• <strong>Tanggal Gabung (Kolom O):</strong> WAJIB, format YYYY-MM-DD</li>
                                    <li>• <strong>Status Keluar (Kolom P & Q):</strong> Jika status = keluar, tanggal_keluar dan alasan_keluar WAJIB diisi</li>
                                    <li>• <strong>User Account:</strong> Jika status keluar, akun pengguna otomatis dinonaktifkan</li>
                                    <li>• <strong>Username Otomatis:</strong> Sama dengan nomor anggota (contoh: 2512.00001 → username: 2512.00001)</li>
